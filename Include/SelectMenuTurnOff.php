                        ...
                        <form method="post" id="InsertGuest" name="form1">
                            ...
                            <div class="card card-user">
                                <div class="content">
                                    ...
                                    <h5 class="title" style="font-weight: 600; text-align: center;">หมายเลขโต๊ะ</h5>
                                    <?php }else{?>
                                ...
                                <div class="container" style="width:100%;">  
                                   <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="GuestCompany" id="GuestCompany" placeholder="กรุณากรอกชื่อบริษัท" class="form-control border-input" disabled/>
                                        </div>
                                    </div>
                                   ...
                                   <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="GuestName" id="GuestName" placeholder="กรุณากรอกชื่อ - นามสกุล (ผู้จอง)" class="form-control border-input" disabled/>
                                        </div>
                                    </div>
                                   ...
                                   <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="GuestEmail" id="GuestEmail" placeholder="กรุณากรอก E-mail " class="form-control border-input" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="GuestTel" id="GuestTel" placeholder="กรุณากรอกเบอร์โทรติดต่อ"  class="form-control border-input" maxlength="10" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="GuestTelBackup" id="GuestTelBackup" placeholder="กรุณากรอกเบอร์โทรสำรอง"  class="form-control border-input" maxlength="10" disabled/>
                                        </div>
                                    </div>
                                   ...
                                   <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="LineID" id="LineID" placeholder="กรุณากรอก Line ID" class="form-control border-input" maxlength="10" disabled/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <br/><label class="control-label" for="input4">วันเวลาที่เข้าร้าน</label>
                                        <div class="controls">
                                            <input type="text" class="form-control border-input" value="<?php echo DateThai($_SESSION["SelectDate"]);?>" style="text-align: center; font-weight: 600;" disabled>
                                            ...
                                            <table style="width:100%">
                                                <tr><td style="width:50%">
                                                    <select name="Hour" id="Hour" class="toggle-divs form-control border-input" onchange="countryChange(this);" disabled>
                                                        <option value="empty">เลือกชั่วโมง</option>
                                                    ...
                                                    <td style="width:50%">
                                                    <select name="Minute" id="Minute" class="toggle-divs form-control border-input" disabled>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text"  name="GuestNum" id="GuestNum"  placeholder="กรอกจำนวนลูกค้า" class="form-control border-input" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="TotalPrice" id="TotalPrice" placeholder="รวมราคาอาหาร" class="form-control border-input" disabled/>
                                        </div>
                                    </div>
                                   ...
                                   <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="Pledge" id="Pledge" placeholder="จำนวนเงินมัดจำ" class="form-control border-input" disabled/>
                                        </div>
                                    </div>

                                        <div class="control-group">
                                        <br/><label class="control-label" for="input6">เลือกประเภทรายการอาหาร</label>
                                            <select name="GuestType" id="GuestType" class="toggle-divs form-control border-input" disabled>
                                   ...
                                   <br/><div class="form-actions" style="text-align:  center;">
                                        ...
                                        <button type="reset" class="btn btn-warning" style="width:49%;" disabled>
