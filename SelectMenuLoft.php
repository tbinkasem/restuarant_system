                        ...
                        <form method="post" id="InsertGuest" name="form1">
                            ...
                            <div class="card card-user">
                                <div class="content">
                                    ...
                                    <?php }else{?>
                                    <?php include ('Include/ChangeIcon.php');?>                 
                                    <?php }?>   
                                    <?php }else{?>
                                    ...
                                    <p style="color: black; display: inline-block; font-size: 18px;"><?php echo (int)substr(base64url_decode($_SESSION["TableID"]), 3, 3);?></p></h5>
                                    ...
                                    <?php }?>
                                    <?php }else{?>
                                    <h5 class="title" style="color: red; font-weight: 600; text-align: center;">กำลังเลือกย้ายโต๊ะหมายเลข <?php echo (int)substr(base64url_decode($_SESSION["TableID"]), 3, 3);?></h5>
                                    <?php }?>
                                    ...
                                    <?php if(!$_SESSION["MoveTable"]){?>
                                        <?php if(!$_SESSION["GetNewTable"]){?>
                                        <h5><?php echo $new_var = (int)substr($values["item_name"], 3, 3); ?>
                                        ...
                                        <?php }else{?>
                                        <h5><?php echo $new_var = (int)substr($values["item_name"], 3, 3); ?></h5>
                                    <?php }?>
                                    <?php }else{?>
                                        <h5 style="color: red;">ย้ายโต๊ะหมายเลข<br></h5><h5><?php echo (int)substr(base64url_decode($_SESSION["TableID"]), 3, 3);?> <i class="ti-angle-double-right"></i> 
                                        <?php echo $new_var = (int)substr($values["item_name"], 3, 3); ?></h5>
                                    <?php }?>
                                    </div>
